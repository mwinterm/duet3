; setoffset.g - Measure and set the length offset of the current tool
;
...
;
; Usage: select the tool first (e.g. T0), then run:  M98 P"setoffset.g"
...
if state.currentTool < 0
    abort "setoffset.g: no tool selected. Select a tool (e.g. T0) before running the tool setter."
if !move.axes[0].homed || !move.axes[1].homed || !move.axes[2].homed
    abort "setoffset.g: home all axes (G28) before running the tool setter."
